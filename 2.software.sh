...
# Utilities
sudo pacman -S git filezilla htop screenfetch fastfetch pacman-contrib reflector speedtest-cli
sudo pacman -S splix cups cups-pdf inetutils dnsutils ntfs-3g
...
sudo pacman -S debugedit fakeroot flatpak arandr
